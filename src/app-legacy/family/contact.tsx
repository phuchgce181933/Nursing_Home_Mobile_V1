  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <ThemedText style={styles.headerTitle}>Liên hệ</ThemedText>
        <View style={{ width: 36 }} />
      </View>
      <View style={styles.body}>
        <ThemedText style={styles.icon}>💬</ThemedText>
        <ThemedText style={styles.title}>Sắp ra mắt</ThemedText>
        <ThemedText style={styles.sub}>Chức năng nhắn tin với điều dưỡng đang được phát triển.</ThemedText>
      </View>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#00838F', padding: Spacing.three, gap: Spacing.two, margin: Spacing.three, borderRadius: Radius.lg, ...Shadow.md },
