...
import { Text, Card, Chip, Button, Dialog, Portal, TextInput } from 'react-native-paper';
            ...
            <Card style={styles.card} mode="outlined">
              ...
              {item.status === 'pending' && canReview ? (
                <Card.Actions>
                  ...
                  <Button compact mode="contained" buttonColor={roleColor} onPress={() => approveMut.mutate(item._id)} loading={approveMut.isPending}>{t(`${NS}.approve`)}</Button>
                </Card.Actions>
              ) : null}
            </Card>
          )} />
